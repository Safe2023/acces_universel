...
<div class="row">
	<div class="col-md-12 text-center mt-5 mb-5">
		<div class="section-title">
			...
			<p>Restez informé des dernières nouvelles, événements à venir. Nous mettons régulièrement à jour cette section pour vous offrir les informations les plus pertinentes.</p>
		</div>
	</div>
</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="small text-muted text-center" style="font-size: 20px;">
                                            <span>{{ \Carbon\Carbon::parse($actualite->date)->format('d/m/Y') }}</span>
                                        </div>
                                    </div>

                                    <!-- Détails à droite -->
                                    <div class="col-md-7">
                                        <h5 class="mb-2 text-center" style="color: #f99828;">
                                            {{ $actualite->titre }}
                                        </h5>
