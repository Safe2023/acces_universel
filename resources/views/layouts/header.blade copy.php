            ...
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="site-logo mt-2">
                        <a class="navbar-logo" href="/"><img src="assets/img/au/logo_04.webp" alt=""></a>
                    </div>
                </div>
                    ...
                    <div class="header_right">
                        <nav id="main-menu" class="ml-auto">
                            <ul>
                                ...
                                <li><a class="arrow-btn" href="service.html">Ressources</a>
                                    <ul class="sub-menu ">
                                        <li><a href="service.html " class="nav-link">Associers-gouvernance</a></li>
                                        <li><a href="service_two.html " class="nav-link">Devenir Partenaire</a></li>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 text-end mt-2">
                    <a href="" class="btn btn-secondary "><i class="fa fa-user" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    </div> -->
